...
namespace GPUInstance
{
    public class InstanceMeshPropertyPaths
    {
        ...
        public int UpdateComputeBuffers(ComputeBuffer buffer_delta, ComputeBuffer buffer_delta_ids, UnityEngine.Rendering.CommandBuffer cmd)
        {
            ...
            // Set buffer
            cmd.SetComputeBufferData(buffer_delta_ids, this._path_id_delta_buffer.Array, this._delta_offset, 0, delta_count);
            cmd.SetComputeBufferData(buffer_delta, this._delta_buffer.Array, this._delta_offset * this.PathFloatStride, 0, delta_count * this.PathFloatStride);
