...
namespace GPUInstance
{
    public class GroupBindPosesDeltaBuffer
    {
        ...
        public int UpdateComputeBuffer(ComputeBuffer cBuffer, UnityEngine.Rendering.CommandBuffer cmd)
        {
            ...
            // Set buffer
            cmd.SetComputeBufferData(cBuffer, this._delta_buffer.Array, this._delta_offset * DeltaStride, 0, delta_count * this.DeltaStride); // cBuffer.SetData(this._delta_buffer.Array, 0, 0, delta_count * this.DeltaStride);
